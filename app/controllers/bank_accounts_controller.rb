class BankAccountsController < ApplicationController
   http_basic_authenticate_with :name => "manager", :password => "secret", :except => [:index, :show]
  ...
  def create
    ...
    respond_to do |format|
      if @bank_account.save
        format.html { redirect_to @bank_account, notice: 'Bank account was successfully added.' }
